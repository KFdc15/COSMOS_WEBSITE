...
export default function Home() {
  ...
  return (
      <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-6 pb-10 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
        <NavBar />
        ...
        <main className="flex flex-row w-full h-full z-10">
          <PlanetComponent />
          <div className="text-white text-xl text-center max-w-xs text-left">
            <p>{desc}</p>
          </div>
        </main>
